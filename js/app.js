...
// 			function () {
// 				$('.compet2').animate({ opacity: 1 }, 600,
// 					function () {
// 						$('.compet3').animate({ opacity: 1 }, 500,
// 							function () {
// 								$('.compet4').animate({ opacity: 1 }, 400,
// 									function () {
// 										$('.compet5').animate({ opacity: 1 }, 300,
// 											function () {
// 												$('.compet6').animate({ opacity: 1 }, 300,
// 													function () {
// 														$('#competences').children('a').animate({ opacity: 1 }, 300,
// 															function () {
// 																$('.compet8').animate({ opacity: 1 }, 300,
// 																	function () {
// 																		$('.compet9').animate({ opacity: 1 }, 200,
